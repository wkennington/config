...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "Code", "Net", "Float", "Ext1", "Ext2"}, s, layouts[2])
...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, beautiful.awesome_icon },
							 { "Empathy", "empathy" },
							 { "File Manager", "dbus-launch pcmanfm" },
							 { "Firefox", "firefox" },
							 { "Gimp", "gimp" },
							 { "Geany", "geany" },
...
globalkeys = awful.util.table.join(
    awful.key({                   }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/screenshots; eog ~/screenshots/$f'") end),
    awful.key({ modkey,           }, "a", function () awful.util.spawn("xscreensaver-command -lock") end),
    awful.key({ modkey,           }, "s", function () awful.util.spawn("gksudo pm-suspend") end),
    awful.key({ modkey, "Shift"   }, "s", function () awful.util.spawn("gksudo \"shutdown -r now\"") end),
    awful.key({ modkey, "Control" }, "s", function () awful.util.spawn("gksudo \"shutdown -hP now\"") end),
